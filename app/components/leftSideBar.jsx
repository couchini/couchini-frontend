        ...
        <div className="bg-slate-900 md:h-screen sm:w-full grid grid-cols-1">
            <div className="flex md:grid grid-col-1 md:justify-normal justify-around md:self-start md:py-4 border-b border-gray-800 col-span-1">
                ...
                <div className="md:grid flex flex-col grid-cols-6 my-2 items-center">
                    ...
                    <div className={`col-span-1 flex justify-center p-1 md:bg-inherit rounded-lg ${current === "explore" && "bg-gray-600"}`}>
                        <GoSearch
                            className={current === "explore" ? "text-sky-500" : "text-gray-300"}
                            size={"1.4rem"} />
                    </div>
                    <p className={`text-gray-300 font-semibold col-span-4 text-sm ${current === "explore" && "text-sky-500"}`}>Explore</p>
                </div>
                <div className="md:grid flex flex-col grid-cols-6 my-2 items-center">
